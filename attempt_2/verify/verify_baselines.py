...
BASE_DIR = 'attempt_2/verify/baseline'
...
if __name__ == '__main__':
    ...
    with ThreadPoolExecutor(max_workers=12) as ex:
        futs = {ex.submit(cell_worker, cell, cands[:20]): cell for cell, cands in pool.items()}
    ...
    json.dump(final, open('attempt_2/verify/baseline_summary.json','w'), indent=2)
