...
TARGETS = ['junit4-mockito__j8__4','junit4-mockito__j8__7']
...
def run_one(e):
    ...
    with sem:
        try: subprocess.run([f"{HERE}/attempt_2/iter-010/run_one.sh"], env=env, timeout=1500, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
