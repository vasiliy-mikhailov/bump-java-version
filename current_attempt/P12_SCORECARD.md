...
| tpiekarski/coupon-engine | 15 | [#5](https://github.com/tpiekarski/coupon-engine/issues/5) | 8→11 | jacoco 0.7.7→0.8.14, +`jakarta.inject-api`, `Path.of` | 40/40 | _ready_ | awaiting go-ahead |
