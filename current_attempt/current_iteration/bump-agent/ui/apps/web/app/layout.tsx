...
export const metadata: Metadata = {
  title: 'Bump Java version',
  description: 'Moves Java projects between LTS levels, and proves it kept every test that passed.',
}
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body>
        {/*
          NO CENTRED COLUMN. The sibling's screens run full width with a 24px gutter, and two tools
          behind one nav have to agree about where the page starts: a zone that insets its content by
          a different amount reads as a different site the moment a reader crosses the boundary.
        */}
