 ...
 * over modules, so is plain code that calls no model at all. They compose because they are the same
 ...
 *
 * <p>IT STANDS ALONE BECAUSE IT SAYS NOTHING ABOUT JAVA VERSIONS. It was nested inside
 * {@code Agents}, a thousand lines of prompts about pom files and jakarta packages, so
 * {@link Flow}, {@link Shape} and {@link Triad}, none of which knows what a bump is, could not be
 * read, moved or reused without the whole catalogue coming with them. Three names and no domain:
 * run something, say what to call it, say what it contains.
 */
@FunctionalInterface
