 ...
 * nesting, how often each one ran and which list each one worked to, beside a {@code Bump} that did
...
public final class Shape {
    ...
    /** Every agent the tree reaches, in the order it reaches them. What {@code Agents} must define. */
