 ...
 * It lived on {@code Bump} because that is where the first caller was, which meant {@link Triad}
 * and {@code Supervisor} reached into the program class to parse a sentence. A parser is not a
