...
public interface Trace {
    ...
    /**
     * WHAT A BUILD DID, in the three facts a record is entitled to.
     *
     * <p>{@link #built} used to take {@code Runner.Result}, which is the Java build runner's own
     * type, and that one parameter was the whole reason a general record writer could not exist
     * without the Maven and Gradle shelling out coming with it. The three facts are not about Java: a thing
     * ran or it did not, it passed or it did not, and here is what it said.
     *
