 ...
 * declared there, and carried out in {@code Bump}. Two copies of one fact drift, and that pair did:
...
public final class Flow {
     ...
     * exist in {@code Agents}, around the model call inside an agent, and no settlement passes
