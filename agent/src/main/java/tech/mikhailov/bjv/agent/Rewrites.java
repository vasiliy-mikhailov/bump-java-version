...
final class Rewrites {
     ...
     */
    static Map<ToolSpecification, ToolExecutor> patchBump(Path root, Migrate migrate,
     ...
     */
    static Map<ToolSpecification, ToolExecutor> lineBump(Migrate migrate, Tree tree, String jdk) {
        ToolSpecification spec = ToolSpecification.builder()
                .name("bump_line")
     ...
     */
    static Map<ToolSpecification, ToolExecutor> recipe(Migrate migrate, Tree tree, String jdk) {
        ToolSpecification spec = ToolSpecification.builder()
                .name("apply_recipe")
