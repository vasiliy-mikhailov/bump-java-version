 ...
 *
 * <p>Every verifier in this program answers with one of a closed set, and this is what reads it.
 * It lived on {@link Bump} because that is where the first caller was, which meant {@link Triad}
 * and {@link Supervisor} reached into the program class to parse a sentence. A parser is not a
 * program, and eight call sites across three classes is not a private helper.
 *
